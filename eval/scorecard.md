...
| 2 | Command injection | `vuln/command-injection` | — |  |  |  |  |  |  |
...
### Aggregate scores (fill in once all 10 vuln runs are complete)

- **True positives:** _ / 10
- **False negatives:** _ / 10
- **Severity accuracy (got == expected):** _ / 10
- **Fix quality == Good:** _ / 10
